<?php include('include/header.php'); ?>
   ...
   <?php include('include/sidebar.php'); ?>  
        ...
        <section class="content">
         ...
         <div class="col-md-12">
            ...
            <div class="panel panel-default">
              ...
              $del_query = "DELETE FROM tbl_product_comment WHERE id='$del_post_id'";
     ...
     <?php 
     $query = "select tbl_product.*,tbl_product_comment.*
               from tbl_product
               inner join tbl_product_comment
               on tbl_product.id = tbl_product_comment.product_id
