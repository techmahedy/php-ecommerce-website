 ...
 <?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == "POST"){
      ...
      $level     = $sql_injection->validation($_POST['level']);
      ...
      $userid    = $sql_injection->validation($_POST['userid']);
        ...
        if ($name == "" || $username == "" || $email == "" || $password == "" || $file_name == "" || $level ==""){
     ...
     $query = "INSERT INTO 
               tbl_admin(name,username,email,password,level,image) 
               VALUES('$name','$username','$email','$password','$level','$uploaded_image')";
